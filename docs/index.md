...
4. [Setting up Quelea for your needs](Setting_up_Quelea_for_your_needs "Setting up Quelea for your needs")
    ...
    9. [Advanced settings](Advanced_settings "Advanced settings")
        ...
        2. [Fade in/out adjustments](Advanced_settings#fade-in/out-adjustments "Fade in/out adjustments")
        3. [Margins](Advanced_settings#margins "Margins")
        4. [Automatically extend projection window to a recently plugged in device](Advanced_settings#automatically-extend-projection-window-to-a-recently-plugged-in-device "Automatically extend projection window to a recently plugged in device")
        5. [Adjust fade transition speed](Advanced_settings#adjust-fade-transition-speed "Adjust fade transition speed")
