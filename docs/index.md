...
4. [Setting up Quelea for your needs](Setting_up_Quelea_for_your_needs "Setting up Quelea for your needs")
   1. [General tab](General_tab "General tab")
      1. [User Options](General_tab#user-options "General tab")
         ...
         3. [Check for update on startup](General_tab#check-for-update-on-startup "General tab")
         4. [Warn if only one monitor is connected](General_tab#warn-if-only-one-monitor-is-connected "General tab")
         5. [Only preview one line per song section](General_tab#only-preview-one-line-per-song-section "General tab")
         6. [Database song preview](General_tab#database-song-preview "General tab")
         ...
         13. [Allow custom item theme to overwrite global theme](General_tab#allow-custom-item-theme-to-overwrite-global-theme "General tab")
         ...
         16. [Thumbnail size](General_tab#thumbnail0-size "General tab")
         17. [Show extra live panel toolbar options](General_tab#show-extra-live-panel-toolbar-options "General tab")
   ...
   9. [Import/Export tab](Import_Export "Import/Export tab")
